(function() {
    ...
    backlinkContainer.setAttribute('aria-label', 'Powered by CloserFlow');

    const backlink = document.createElement('a');
    backlink.href = 'https://www.closerflow.com';
    backlink.textContent = 'CloserFlow - WhatsApp Chat Widget for Business';
    ...
    schema.textContent = JSON.stringify({
        ...
        "name": "CloserFlow WhatsApp Chat Widget",
        "applicationCategory": "BusinessApplication",
        "description": "WhatsApp Chat Widget for Business by CloserFlow",
        "operatingSystem": "Any",
        "offers": {
            "@type": "Offer",
            "url": "https://www.closerflow.com"
        },
        "provider": {
            "@type": "Organization",
            "name": "CloserFlow",
